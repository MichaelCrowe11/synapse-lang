...
class IBMQuantumBackend(QuantumBackend):
    ...
    def __init__(self, backend_name: str = "ibmq_qasm_simulator", token: Optional[str] = None):
    ...
    def get_device_info(self) -> QuantumDeviceInfo:
        ...
        if self.backend:
            ...
            return QuantumDeviceInfo(
                ...
                error_rates=self._get_error_rates() if not "simulator" in self.backend_name.lower() else None
            )
...
class GoogleQuantumBackend(QuantumBackend):
    ...
    def __init__(self, processor_id: str = "rainbow", project_id: Optional[str] = None):
...
class IonQBackend(QuantumBackend):
    ...
    def __init__(self, api_key: Optional[str] = None, device: str = "simulator"):
...
class QuantumHardwareManager:
    ...
    def get_backend_info(self, name: Optional[str] = None) -> QuantumDeviceInfo:
    ...
    def execute_on_backend(self, circuit: Any, backend: Optional[str] = None, shots: int = 1024) -> Dict[str, Any]:
    ...
    def optimize_for_backend(self, circuit: Any, backend: Optional[str] = None) -> Any:
