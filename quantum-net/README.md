...
The older backbone, teleportation and QKD examples are roadmap material and now live in `examples/roadmap/`; they do not
parse under the current grammar and are not installed-wheel acceptance examples. See `../docs/trinity-implementation-blueprint.md`.
...
2.  **Run an example:**
    ...
    # both report mode: parse-only. Roadmap programs live in examples/roadmap/ and do not parse yet.
    ```
