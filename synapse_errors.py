...
class ErrorContext:
    ...
    variables: dict
    call_stack: List[str]
    parallel_branch: Optional[str] = None
...
class SyntaxError(SynapseError):
    ...
    def __init__(self, message: str, location: ErrorLocation, suggestion: Optional[str] = None):
...
class NameError(SynapseError):
    ...
    def __init__(self, name: str, location: Optional[ErrorLocation] = None,
...
class ErrorHandler:
    ...
    def add_warning(self, message: str, line: Optional[int] = None) -> None:
...
class ErrorRecovery:
    ...
    @staticmethod
    def suggest_fix(error_type: str, context: dict) -> Optional[str]:
...
def get_error_handler(source_code: Optional[str] = None) -> ErrorHandler:
