...
try:
    ...
    from qiskit.algorithms import VQE, QAOA, AmplificationProblem, Grover
...
class QuantumAlgorithms:
    ...
    def grovers_search(self, n_qubits: int, oracle_function: Callable[[int], bool],
                      max_iterations: Optional[int] = None) -> QuantumAlgorithmResult:
        """
...
class QuantumOptimization:
    ...
    def hybrid_classical_quantum_optimization(self, cost_function: Callable,
        ...
        def objective_function(params):
            ...
            bound_circuit = quantum_circuit.bind_parameters(dict(zip(quantum_circuit.parameters, params)))
