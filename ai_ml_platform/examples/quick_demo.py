...
from src.neural_network_dsl import NeuralNetwork, Dense
...
def main():
    ...
    try:
        ...
        from src.model_deployment import create_model_server, InferenceRequest
        ...
        from src.automl_optimizer import HyperparameterSpace, HyperparameterRange
