...
from quantum_computing import ClassicalRegister, QuantumCircuit, QuantumRegister

from .neural_network_dsl import ActivationType, Layer, NeuralNetwork
...
class QuantumLayer(Layer):
    ...
    def build_variational_circuit(self, parameters: np.ndarray) -> QuantumCircuit:
        ...
        for _layer in range(self.config.num_layers):
            # Rotation layer
