...
from src.model_deployment import CloudDeployment, DeploymentTarget, create_model_server
from src.neural_network_dsl import Dense, NeuralNetwork
from src.quantum_neural_networks import QuantumDense, QuantumLayerConfig, create_quantum_classifier
...
def demo_gpu_acceleration():
    ...
    if gpu_manager.devices:
        ...
        gpu_manager.execute_on_gpu("matmul", [A_gpu, B_gpu])
