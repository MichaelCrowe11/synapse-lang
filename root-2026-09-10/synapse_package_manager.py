...
class SynapsePackageManager:
    ...
    def __init__(self, synapse_home: str | None = None):
    ...
    def search(self, query: str, registry: str | None = None) -> list[PackageInfo]:
    ...
    def install(self, package_name: str, version: str | None = None,
    ...
    def _fetch_package_info(self, package_name: str, version: str | None = None) -> PackageInfo | None:
    ...
    def _download_package(self, package_name: str, version: str) -> Path | None:
            ...
            try:
                ...
                if cache_file.exists():
                    ...
                    if cache_age < self.config["cache_ttl"]:
                        console.print("[dim]Using cached package[/dim]")
                        return cache_file
    ...
    def upgrade(self, package_name: str | None = None, version: str | None = None) -> bool:
...
""")
        ...
        console.print("  synapse main.syn")
